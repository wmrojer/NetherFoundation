...
public class BlockNetherOre extends BlockCore {
    ...
    public enum Mapping {
        ...
        GOLD     (0, 0, NFBlocks.VANILLA_ORE),
        IRON     (1, 1, NFBlocks.VANILLA_ORE),
        COAL     (2, 2, NFBlocks.VANILLA_ORE),
        LAPIS    (3, 3, NFBlocks.VANILLA_ORE),
        DIAMOND  (4, 4, NFBlocks.VANILLA_ORE),
        REDSTONE (5, 5, NFBlocks.VANILLA_ORE),
        COPPER   (6, 0, NFBlocks.TF_ORE),
		TIN      (7, 1, NFBlocks.TF_ORE),
		SILVER   (8, 2, NFBlocks.TF_ORE),
		LEAD     (9, 3, NFBlocks.TF_ORE),
		ALUMINUM (10, 4, NFBlocks.TF_ORE),
		NICKEL   (11, 5, NFBlocks.TF_ORE),
		PLATINUM (12, 6, NFBlocks.TF_ORE),
		IRIDIUM  (13, 7, NFBlocks.TF_ORE),
        MITHRIL  (14, 8, NFBlocks.TF_ORE),
        EMERALD  (15, 7, NFBlocks.VANILLA_ORE);
