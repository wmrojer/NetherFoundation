...
public class BlockVanillaEndOre extends BlockCore {

    public static final PropertyEnum<Type> VARIANT = PropertyEnum.create("type", Type.class);

    public BlockVanillaEndOre() {

        super(Material.ROCK, "netherfoundation");

        this.setCreativeTab(Reference.CREATIVE_TAB);
        this.setUnlocalizedName("vanilla_end_ore");
		...
		setHarvestLevel("pickaxe", 2, getStateFromMeta(Type.QUARTZ.getMetadata()));
	...
	public enum Type implements IStringSerializable {
        ...
        QUARTZ   (8,    "quartz",   0,     EnumRarity.COMMON);
